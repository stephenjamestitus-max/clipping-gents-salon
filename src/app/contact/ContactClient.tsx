    ...
    <div className="bg-[#0F0F0F] min-h-screen pt-28 pb-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <SectionReveal>
              <div className="bg-[#1A1A1A] border border-[#C9A84C]/15 rounded-2xl p-7">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2
                    className="text-[#F5ECD7] font-bold text-lg"
                    style={{ fontFamily: "var(--font-playfair)" }}
                  >
                    Location
                  </h2>
          ...
          {/* Right: Map embed */}
          <SectionReveal delay={0.2} className="flex flex-col">
            <div className="bg-[#1A1A1A] border border-[#C9A84C]/15 rounded-2xl overflow-hidden flex-1 min-h-[400px] lg:min-h-0">
