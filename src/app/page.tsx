...
const teamTeasers = [
  { name: "Abdul Jabbar", role: "Lead Stylist", initials: "AJ", specialty: "Fades & Classic Cuts", badge: "Most Reviewed" },
  { name: "Muhamad",      role: "Senior Barber", initials: "MH", specialty: "Haircuts & Shaves",   badge: "" },
  { name: "Mazhar Iqbal", role: "Grooming Expert", initials: "MI", specialty: "Beard & Hair Styling", badge: "" },
];
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="bg-[#0F0F0F] py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <SectionReveal className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#F5ECD7]" style={playfairStyle}>
            ...
            {services.map((svc, i) => (
              <SectionReveal key={svc.title} delay={i * 0.08}>
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-[#F5ECD7] font-bold text-lg mb-2" style={playfairStyle}>
                      {svc.title}
                    </h3>
              ...
              <SectionReveal key={stylist.name} delay={i * 0.1}>
                <div className="text-center group">
                  <div className="relative w-24 h-24 rounded-full mx-auto mb-5 bg-[#C9A84C]/10 border-2 border-[#C9A84C]/30 flex items-center justify-center group-hover:border-[#C9A84C] transition-colors duration-300">
                    <span className="text-2xl font-bold text-[#C9A84C]" style={playfairStyle}>
                      {stylist.initials}
                    </span>
                    {stylist.badge && (
                  ...
                  <h3 className="text-[#F5ECD7] font-bold text-lg mb-1" style={playfairStyle}>
                    {stylist.name}
                  </h3>
      ...
      {/* ── FINAL CTA ─────────────────────────────────── */}
      <section className="bg-[#1A1A1A] py-28 px-6 border-t border-[#C9A84C]/10">
        <div className="max-w-3xl mx-auto text-center">
          <SectionReveal>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#F5ECD7] mb-5" style={playfairStyle}>
